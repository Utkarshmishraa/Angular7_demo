...
describe('AuthService', () => {
  ...
  it('should return whether the user is login', fakeAsync(() => {
    let response = true;
    ...
    //var results = service.isLoggedIn();
    //expect(results).toBeTruthy();
    //tick();
    //tick(1000);
  }));

  it('should return all the login parameters', fakeAsync(() => {
    let  response ="vvgAsByP81FyFfAqoACsuoqfQNhAE5o6GxrwSd30McZCg0b4MnPaTRidXtt8uiJDFa1NaUIn7ohuOmwoMEbgIJxqJ5r3kVfBOrqH49TGtmJzQCUMaxl4zcByKo5yF4F3cbMrRwuFR9eVnbJDOVMThGSiIEZ2QYeKDqNUJo4m0nJPF23FkOqNFgDD"; 
